...
// <h> RAM Configuration
// =======================
// <h> __RAM0 (is rwx memory: ITCM_S from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
...
// <h> __RAM1 (is rwx memory: SRAM_S from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
//   <i> Defines base address of memory region. Default: 0x12000000
#define __RAM1_BASE 0x12000000
//   <o> Region size [bytes] <0x0-0xFFFFFFFF:8>
//   <i> Defines size of memory region. Default: 0x00200000
