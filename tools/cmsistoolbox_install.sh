...
if [ $(uname -m) = "x86_64" ]; then
    wget https://artifacts.tools.arm.com/cmsis-toolbox/2.7.0/cmsis-toolbox-linux-amd64.tar.gz -nv
    ...
    wget https://artifacts.tools.arm.com/cmsis-toolbox/2.7.0/cmsis-toolbox-linux-arm64.tar.gz -nv    
